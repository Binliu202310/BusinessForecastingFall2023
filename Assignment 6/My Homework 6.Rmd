...
#### The plot for 1st order difference shows that the time series becomes quite stationary from 2017 to 2021 then slight upward trending after year 2021. Based on ACF, the historical data becomes less and less significant. Based on PACF, the first number for P may 1, 2, or 3 since the first, second and third lags are above the range line. 
